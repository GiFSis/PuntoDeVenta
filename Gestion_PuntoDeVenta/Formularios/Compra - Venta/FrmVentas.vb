Public Class FrmVentas
    ...
    Private Sub BtnVenta_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnVenta.Click
        If DataGridViewIngVenta.RowCount = 0 Then
            ...
            Txtcantidad.Select()
        Else
            FrmVuelto.MdiParent = MDIMenu
            FrmVuelto.Show()
            FrmVuelto.TxtVenta.Text = TxtTotal.Text
            FrmVuelto.TxtPago.Text = TxtTotal.Text
        End If
    End Sub
    ...
    Private Sub LblIdCliente_TextChanged(sender As Object, e As EventArgs) Handles LblIdCliente.TextChanged
